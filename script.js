...
.nav-container nav .nav-links a:hover{
    color: #fec303;
}
...
.nav-container .hamburger  .line2, .line3{
    height: 4px;
    width: 35px;
    margin-top: 4px;
    background-color: #fec303;
...
@media(min-width:575px) {
    .nav-container nav .nav-links.responsive{
        display: flex;
        position: relative;
        top: 0%;
        left: 0%;
    ...
    .nav-container.sticky nav .nav-links {
        top: 0% !important;
    }
}
...
@media(max-width:574px) {
    ...
    .main-container {
        background: url(/Images/background2.jpeg) no-repeat center;
        background-size: cover;
        height: 100vh;
        width: 100vw;
    }
...
.nav-container .nav-links.responsive {
    display: block;
    position: absolute;
